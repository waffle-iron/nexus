...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Nexus\GoogleAppEngineBundle\UserManagement A Nexus\GoogleAppEngineBundle\UserManagement instance.
     */
    protected function getUserService()
    {
        return $this->services['user'] = new \Nexus\GoogleAppEngineBundle\UserManagement();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('577e550285a078.93012780')), true);
